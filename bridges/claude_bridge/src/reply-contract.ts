...
export function buildStructuredReplyInstructions(policy: ChannelPolicy): string {
  ...
  return [
    ...
    "4. intent 只允许包含 task_type、priority、requires_approval、deadline、tags、custom；只要 intent 非空，就必须包含 task_type。",
    "",
    "当前频道策略：",
